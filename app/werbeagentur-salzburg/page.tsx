...
export const metadata: Metadata = {
  ...
  keywords: ["werbeagentur", "web agentur", "webagentur", "werbeagentur website", "seo agentur niederösterreich", "suchmaschinenoptimierung niederösterreich", "website werbeagentur", "werbeagentur salzburg", "webdesign salzburg", "homepage salzburg"],
  alternates: {
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-[#1C1C1C] tracking-tight leading-tight mb-6">
                            ...
                            <span className="text-transparent text-[#1C1C1C]">Webdesign in Salzburg</span>
                        </h2>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { title: "Zukunftssicher", desc: "Webseiten, die dank KI-Technologie heute schon die Standards von morgen setzen.", icon: <Zap className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Design-Exzellenz", desc: "Ästhetik auf höchstem Niveau, passend zum Salzburger Qualitätsanspruch.", icon: <Monitor className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Smart SEO", desc: "KI-gestützte Optimierung für messbare regionale Sichtbarkeit.", icon: <TrendingUp className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Partnerschaft", desc: "Persönliche Betreuung und nahtlose Kommunikation via Video-Call.", icon: <Handshake className="w-5 h-5 text-[#F7C429]" /> },
                        ].map((item, i) => (
...
<span className="font-sans block text-transparent text-[#1C1C1C] pb-2">in der Festspielstadt</span>
</h2>
                  ...
                  <div className="flex flex-col gap-4 mb-10">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           <h4 className="font-bold text-[#1C1C1C] text-lg font-sans">KI-Vorsprung</h4>
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Nutze modernste Algorithmen für dein regionales Marketing in Salzburg.</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl bg-[#F7C429]/20 border border-accent/30 flex items-center justify-center shrink-0">
                        ...
                        <div>
                           ...
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Targeting-Strategien, die du exakt in deiner Zielgruppe platzieren.</span>
                        </div>
                     </div>
                  </div>
               </ScrollReveal>
                  ...
                  <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#1C1C1C]/10 shadow-sm relative">
                     ...
                     <div className="flex items-center gap-4 mb-6">
                         ...
                         <div>
                             ...
                             <h4 className="font-bold text-[#1C1C1C] leading-tight">Marion Bald</h4>
