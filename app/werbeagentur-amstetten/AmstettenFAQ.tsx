                        ...
                        >
                            <div className="group border-b border-gray-200">
                                ...
                                >
                                    ...
                                    <div className={`shrink-0 flex items-center justify-center mt-1 transition-transform duration-500 ${openIndex === index ? 'rotate-180 text-accent' : 'text-gray-400 group-hover:text-gray-600'}`} aria-hidden="true">
