...
export const metadata: Metadata = {
  ...
  keywords: ["werbeagentur", "web agentur", "webagentur", "werbeagentur website", "seo agentur niederösterreich", "suchmaschinenoptimierung niederösterreich", "website werbeagentur", "werbeagentur wien", "webdesign wien", "homepage wien"],
  alternates: {
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-[#1C1C1C] tracking-tight leading-tight mb-6">
                            ...
                            <span className="text-transparent text-[#1C1C1C]">für den Standort Wien</span>
                        </h2>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { title: "Wiener Markt", desc: "Konvertierende Landingpages für das hart umkämpfte Umfeld.", icon: <Building2 className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "KI-Power", desc: "Smarte Chatbots und automatisierte Marketing-Funnels.", icon: <Brain className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Effizienz", desc: "Premium-Qualität zu fairen, regionalen Business-Preisen.", icon: <Zap className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Digital-First", desc: "Nahtlose Abstimmung via Video-Call ohne Zeitverlust.", icon: <Handshake className="w-5 h-5 text-[#F7C429]" /> },
                        ].map((item, i) => (
...
<span className="font-sans block text-transparent text-[#1C1C1C] pb-2">im Großraum Wien</span>
</h2>
                  ...
                  <div className="flex flex-col gap-4 mb-10">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           <h4 className="font-bold text-[#1C1C1C] text-lg font-sans">Mitarbeitergewinnung</h4>
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Automatisierte Recruiting-Webseiten für den Wiener Arbeitsmarkt.</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl bg-[#F7C429]/20 border border-accent/30 flex items-center justify-center shrink-0">
                        ...
                        <div>
                           <h4 className="font-bold text-[#1C1C1C] text-lg font-sans">Lokales SEO</h4>
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Mach deinen Betrieb im passenden Wiener Bezirk online zum Platzhirsch.</span>
                        </div>
                     </div>
                  </div>
               </ScrollReveal>
                  ...
                  <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#1C1C1C]/10 shadow-sm relative">
                     ...
                     <div className="flex items-center gap-4 mb-6">
                         ...
                         <div>
                             ...
                             <h4 className="font-bold text-[#1C1C1C] leading-tight">Susanne Wolfsohn</h4>
