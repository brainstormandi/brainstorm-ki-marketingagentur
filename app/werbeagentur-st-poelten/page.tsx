            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                <div className="max-w-2xl xl:max-w-3xl">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-slate-900 tracking-tight leading-[1.1] py-1 mb-6 animate-reveal-up">
                       <span className="font-sans font-black block">Modernstes Webdesign für</span>
                       <span className="font-sans block text-transparent bg-clip-text bg-gradient-to-br from-slate-900 via-slate-800 to-slate-600 drop-shadow-sm pb-2">St. Pölten & NÖ</span>
                    </h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { title: "Regionale Stärke", desc: "Fokussiert auf den Zentralraum St. Pölten und das Traisental.", icon: <Building2 className="w-5 h-5 text-accent" /> },
                            { title: "Premium UI", desc: "Webdesign, das auf allen Endgeräten atemberaubend aussieht.", icon: <Monitor className="w-5 h-5 text-accent" /> },
                            { title: "Smart Copy", desc: "Verkaufsstarke Websitetexte dank KI-Unterstützung.", icon: <Brain className="w-5 h-5 text-accent" /> },
                            { title: "Agiler Service", desc: "Ohne Bürokratie, schnelle Umsetzung und absolute Verlässlichkeit.", icon: <Handshake className="w-5 h-5 text-accent" /> },
                        ].map((item, i) => (
