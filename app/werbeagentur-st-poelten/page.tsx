          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
               <ScrollReveal animation="reveal-right">
                  <h2 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 leading-tight">Digital in der <br/>Landeshauptstadt</h2>
                  ...
                  <div className="flex flex-col gap-4 mb-10">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           ...
                           <span className="text-slate-600 text-sm">Heben Sie sich im Großraum NÖ signifikant vom Durchschnitt ab.</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl bg-accent/20 border border-accent/30 flex items-center justify-center shrink-0">
                        ...
                        <div>
                           ...
                           <span className="text-slate-600 text-sm">Werden Sie in St. Pölten gefunden, wo immer nach Ihnen gesucht wird.</span>
                        </div>
                     </div>
                  </div>
               </ScrollReveal>
