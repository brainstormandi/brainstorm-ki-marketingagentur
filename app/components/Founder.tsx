...
const Founder = () => {
    return (
        <section className="py-40 bg-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-slate-50 rounded-full blur-[120px] -ml-48 -mt-48 opacity-50"></div>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
                    <div className="relative order-2 lg:order-1 animate-reveal-up">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] bg-accent/5 rounded-full blur-[100px] animate-pulse-slow"></div>
                        <div className="relative">
                            {/* Decorative frames */}
                            <div className="absolute inset-0 bg-slate-900 rounded-[4rem] rotate-3 opacity-5 translate-x-6 translate-y-6"></div>
                    ...
                    <div className="order-1 lg:order-2 animate-reveal-up reveal-delay-300">
