...
export const metadata: Metadata = {
  ...
  keywords: ["werbeagentur", "web agentur", "webagentur", "werbeagentur website", "seo agentur niederösterreich", "suchmaschinenoptimierung niederösterreich", "website werbeagentur", "werbeagentur steyr", "webdesign steyr", "homepage steyr"],
  alternates: {
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-[#1C1C1C] tracking-tight leading-tight mb-6">
                            ...
                            <span className="text-transparent text-[#1C1C1C]">Webdesign in Steyr</span>
                        </h2>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { title: "Fokus", desc: "Automatisierte Homepages und vertriebsorientierte Landingpages.", icon: <Building2 className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Erreichbarkeit", desc: "Direkte Unterstützung in unter 30 Minuten für Betriebe in Steyr.", icon: <Zap className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Qualität", desc: "Psychologisch fundierte Texte vereint mit KI-Performance.", icon: <Brain className="w-5 h-5 text-[#F7C429]" /> },
                            { title: "Vertrauen", desc: "Exzellente Google-Bewertungen aus dem gesamten Umkreis.", icon: <Handshake className="w-5 h-5 text-[#F7C429]" /> },
                        ].map((item, i) => (
...
<span className="font-sans block text-transparent text-[#1C1C1C] pb-2">die Eisenstadt</span>
</h2>
                  ...
                  <div className="flex flex-col gap-4 mb-10">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           <h4 className="font-bold text-[#1C1C1C] text-lg font-sans">Einzigartiges Webdesign</h4>
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Präzise abgestimmt auf die Zielgruppen in der Region Steyr und Ennstal.</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl bg-[#F7C429]/20 border border-accent/30 flex items-center justify-center shrink-0">
                        ...
                        <div>
                           <h4 className="font-bold text-[#1C1C1C] text-lg font-sans">Nahe & greifbar</h4>
                           <span className="font-[var(--font-inter)] text-[#111827] text-sm">Persönliche Web-Meetings oder direkte Besuche vor Ort.</span>
                        </div>
                     </div>
                  </div>
               </ScrollReveal>
                  ...
                  <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#1C1C1C]/10 shadow-sm relative">
                     ...
                     <div className="flex items-center gap-4 mb-6">
                         ...
                         <div>
                             ...
                             <h4 className="font-bold text-[#1C1C1C] leading-tight">Christian Rohrhofer</h4>
